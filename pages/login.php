...
<div class="login-box">
  ...
  <div class="card login-card">
    <div class="card-body">
      ...
      <form method='POST' action='<?php echo BASE_URL; ?>/actions/proseslogin.php'>

        <div class="mb-3">
          <label class="form-label fw-semibold text-muted" style="font-size:13px;">Username</label>
        ...
        <div class="mb-3">
          <label class="form-label fw-semibold text-muted" style="font-size:13px;">Password</label>
          <div class="input-group">
            ...
            <button type="button" id="togglePass" tabindex="-1"
                    style="border:1.5px solid #e0d0c0;border-left:none;border-radius:0 8px 8px 0;background:#f5ede0;cursor:pointer;padding:0 12px;color:#c8842a;">
        ...
        <div class="mb-3">
          <div class="icheck-primary">
            ...
            <label for="remember">Tetap Login (Remember Me)</label>
          </div>
        </div>
      ...
      <div class="text-center mt-3">
        <p class="mb-2" style="font-size:13px;">Belum punya akun?</p>
        <a href="<?php echo BASE_URL; ?>/pages/daftar.php" class="btn btn-outline-warning" style="border-radius: 8px; padding: 10px 22px; font-weight: 600;">Buat Akun User Baru</a>
      </div>
